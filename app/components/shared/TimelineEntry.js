    ...
    <div className="timeline-entry border p-4 mb-4">
      {isEditing ? (
        <>
          ...
          />
          <button onClick={handleSave} className="mr-2 bg-blue-500 text-white px-4 py-2">
            Save
          </button>
        ...
        <>
          ...
          <button onClick={() => setIsEditing(true)} className="mr-2 bg-yellow-500 text-white px-4 py-2">
            Edit
          </button>
          <button onClick={() => onDelete(entry.id)} className="bg-red-500 text-white px-4 py-2">
            Delete
          </button>
        </>
      )}
