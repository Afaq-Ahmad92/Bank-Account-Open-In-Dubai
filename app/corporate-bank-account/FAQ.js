...
const faqData = [
  {
    question: "What accounting and bookkeeping services does Lawbridge Accounting Services offer?",
  ...
  {
    question: "How does Lawbridge ensure compliance with UAE laws and regulations?",
    answer: "Our team is proficient in local and international accounting standards and regulatory requirements. All accountants are certified and bring years of experience to ensure your business stays compliant with UAE laws, including VAT and financial reporting standards.",
  },
  {
    question: "How do I use Tailwind CSS in Next.js?",
    answer: "To use Tailwind CSS in Next.js, you need to install Tailwind, configure it, and include it in your global CSS file.",
  },
];
